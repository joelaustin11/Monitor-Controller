...
if current_dir != "/mnt/d/Electronics/Monitor-Controller-Firmware/Monitor-Controller/firmware": 
    os.chdir("/mnt/d/Electronics/Monitor-Controller-Firmware/Monitor-Controller/firmware")
